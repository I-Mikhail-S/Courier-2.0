...
import org.example.graphDraft.PathDraft;
import org.example.graphDraft.VertexDraftVertex;
...
public class GraphDraft {
    ...
    private VertexDraft vertexList[]; // список вершин
    ...
    private List<PathDraft> shortestPaths; // список данных кратчайших путей
    private int currentVertex; // текущая вершина
    private int startToCurrent; //расстояние до currentVertex

    public GraphDraft() {
        vertexList = new VertexDraft[MAX_VERTS]; // матрица смежности
    ...
    public void addVertex(char lab) {// задание новых вершин
        vertexList[countOfVertices++] = new VertexDraft(lab);
    }
