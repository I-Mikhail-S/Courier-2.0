...
class FirstPurposeTest {
    ...
    void firstPurpose() throws ParseException {
        ...
        orders.add(new Order(9, new Point(45.0, 4.0), new Point(100.0, 7.0), new Time("15:00", "17:00"), 13.0));
        orders.add(new Order(10, new Point(10.0, 6.0), new Point(99.0, 7.0), new Time("13:00", "15:00"), 14.0));
