...
class FirstPurposeTest {
    ...
    void firstPurpose() throws ParseException {
        ...
        orders.add(new Order(1, new Point(1.0, 2.0), new Point(2.0, 2.0), new Time("08:00", "12:00"), 10.0));
        ...
        orders.add(new Order(4, new Point(9.0, 7.0), new Point(8.0, 6.0), new Time("08:00", "12:00"), 10.0));
        orders.add(new Order(5, new Point(7.0, 1.0), new Point(1.0, 7.0), new Time("08:00", "12:00"), 10.0));
        orders.add(new Order(6, new Point(1.0, 4.0), new Point(9.0, 7.0), new Time("08:00", "12:00"), 10.0));
        orders.add(new Order(7, new Point(2.0, 6.0), new Point(4.0, 7.0), new Time("08:00", "12:00"), 10.0));
        orders.add(new Order(8, new Point(7.0, 7.0), new Point(3.0, 5.0), new Time("08:00", "12:00"), 10.0));
